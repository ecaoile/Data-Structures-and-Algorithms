...
//                Console.WriteLine(front.Values);
...
//        public bool Add(Node root, string key, string value)
//        {
//            if (key == root.Key)
//                return false;
...
//            {
//                Node front = breadth.Dequeue();
//                Console.WriteLine(front.Key);

//                if (value == front.Values)
//                {
//                   if (key == front.Key)
//                    {
//                        front.Count++;
...
//                if (front.Key == key)
//                {
//                    Console.WriteLine($"Found a node: [{front.Key}," +
//                        $" {front.Values}]");
//                    return front.Values;
//                }
